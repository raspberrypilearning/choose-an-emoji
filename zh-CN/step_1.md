有超过 3,000 个表情符号可供你使用。 它们涵盖了各种各样的情感、主题和活动。 它们涵盖了各种各样的情感、主题和活动。

**提示**：表情符号在不同设备上看起来略有不同，因此其他人可能不会看到与你完全相同的图像。 某些设备不支持某些表情符号，这些表情符号会显示为正方形。 某些设备不支持某些表情符号，这些表情符号会显示为正方形。
...
以下是一些你可以在项目中使用的最受欢迎的表情符号。 你可以从这里复制它们。 你可以从这里复制它们。
